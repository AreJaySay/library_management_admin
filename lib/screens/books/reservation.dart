              ...
              children: <TableRow>[
                TableRow(
                  children: <Widget>[
                    ...
                    TableCell(child: Center(child: Text('Reservation date',style: TextStyle(fontFamily: "Roboto_normal",fontWeight: FontWeight.bold,fontSize: 15)))),
                ...
                for(int x = 0; x < _logbooks!.length; x++)...{
                  TableRow(
                    ...
                    children: <Widget>[
                      ...
                      TableCell(child: Center(child: Text('${_logbooks![x]["reserve_date"]}',style: TextStyle(fontFamily: "Roboto_normal")))),
